...
def home_page(request):
    ...
    return render(request, 'home.html', {'user_profile':user_profile, 'post_objects': feed_list, 'suggestions_username_profile_list': suggestions_username_profile_list})
...
def profile_page(request, pk):
    ...
    user_following = len(FollowerCount.objects.filter(follower=follower))
